...
type TWarningKanbanColumnProps = {
...
const WarningKanbanColumn = ({
  ...
  >
    <div className="p-4 border-b border-border/20 flex items-center justify-between">
      ...
      <span
        className="px-2 py-0.5 rounded-full bg-muted/30 text-muted-foreground"
        style={{ fontSize: 11 }}
      >
        {items.length}
      </span>
...
export default memo(WarningKanbanColumn);
