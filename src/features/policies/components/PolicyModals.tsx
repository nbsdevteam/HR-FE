        ...
        >
          ...
          >
            ...
            <form onSubmit={onCreateSubmit} className="space-y-4">
              <PolicyFormFields form={createForm} mode="create" onFormChange={onCreateFormChange} />
              <div className="flex items-center gap-3 pt-4">
                <button type="submit" disabled={isSubmitting} className="flex items-center gap-2 px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-gold-dark transition-colors cursor-pointer disabled:opacity-50">
                  <Save className="w-4 h-4" />
                  {arabicSource("policies.create_the_policy")}
                </button>
                <button type="button" onClick={() => onShowCreateModalChange(false)} className="px-6 py-2 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 transition-colors cursor-pointer">
        ...
        >
          ...
          >
            ...
            <form onSubmit={onEditSubmit} className="space-y-4">
              <PolicyFormFields form={editingPolicy} mode="edit" onFormChange={onEditFormChange} />
              ...
              <div className="flex items-center gap-3 pt-4">
                ...
                <button type="button" onClick={() => onShowEditModalChange(false)} className="px-6 py-2 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 transition-colors cursor-pointer">
                  {arabicSource("common.cancel")}
                </button>
              </div>
            </form>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => onShowViewModalChange(false)} className="p-1 hover:bg-muted rounded-lg transition-colors cursor-pointer shrink-0">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 pb-4 border-b border-border/20">
                ...
                <div>
                  ...
                  <p className={`text-sm font-medium px-2 py-1 rounded-md border w-fit ${policyStatusColors[viewingPolicy.status]}`}>
              ...
              <button onClick={() => onShowViewModalChange(false)} className="w-full px-6 py-2 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 transition-colors cursor-pointer">
