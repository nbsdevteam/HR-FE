import { CalendarDays, Clock, BarChart3, ArrowUpRight, ArrowDownRight, XCircle, TreePalm } from "lucide-react";
...
const PayrollSummaryChips = ({
  ...
  const chips = [
    ...
    },
    {
      ...
      value: leaveRecsCount > 0 ? `${paidLeaveCount}${unpaidLeaveCount > 0 ? ` + ${unpaidLeaveCount} ${arabicSource("payroll.b_r")}` : ""} ${arabicSource("common.days_2")}` : "—",
      icon: TreePalm,
      color: "text-blue-400",
    },
    {
