...
const SHORTFALL_TABLE_HEADINGS = [
  arabicSource("common.date"), arabicSource("common.today"), arabicSource("common.attendance"),
  arabicSource("common.dismissal"), arabicSource("common.working_hours"), arabicSource("common.shortage"),
    ...
    >
        ...
        <div className="flex-1 overflow-y-auto">
          <table className="w-full">
            ...
            <tbody>
              {records.map((rec) => (
                <ShortfallTableRow key={rec.id} rec={rec} targetHours={targetHours} onExcuse={onExcuse} />
              ))}
            </tbody>
          </table>
        </div>
