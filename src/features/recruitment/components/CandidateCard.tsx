  ...
  return (
    ...
    >
      <div className="absolute top-3 start-3 flex items-center gap-1">
        <StatusBadge colorClassName={rank.color} fontSize={11}>
          {score}%
        </StatusBadge>
        ...
        {app.experience_years > 0 && (
          ...
          >
            ...
            <span>
              ...
              {arabicSource("recruitment.years_of_experience")}
            </span>
        ...
        {app.skills && app.skills.length > 0 && (
          <div className="flex flex-wrap gap-1 mt-2">
            {app.skills.slice(0, 4).map((s) => (
              <Chip key={s} label={s} variant="candidate" />
            ))}
            {app.skills.length > 4 && (
              <span
      ...
      <div className="flex items-center justify-between mt-3 pt-3 border-t border-border/20">
        <StatusBadge
          colorClassName={stageColors[app.stage] || ""}
          fontSize={11}
        >
          {app.stage}
        </StatusBadge>
