...
const LeaveRequestModal = ({
  ...
  const submitDisabled =
    employeesLoading ||
    outOfBalance ||
    (selfOnly && (!!linkError || !selfEmployee));
  ...
  return (
    ...
    >
      <ModalHeader
        title={arabicSource("leave.new_leave_request")}
        onClose={onClose}
      />
      ...
      <div className="space-y-4">
        ...
        {isHourly && (
          <>
            ...
            />
            <LeaveRequestHourlySummary
              hours={hourly.hours}
              hourFromFloat={hourly.hourFromFloat}
            />
          </>
        )}
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            placeholder={arabicSource("leave.reason_for_leave")}
        ...
        {selectedType?.requires_attachment && (
          <div
            className="flex items-center gap-2 -mt-2 text-amber-400"
            style={{ fontSize: 12 }}
          >
            {arabicSource(
              "leave.this_type_of_leave_requires_an_attachment_medical_report_etc",
            )}
          </div>
        )}
