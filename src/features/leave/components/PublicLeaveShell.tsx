...
type PublicLeaveShellProps = {
  children: React.ReactNode;
  companyName?: string;
};

/**
 * No-login shell for the public leave-request flow — mirrors
 * `PublicApplyShell`, the equivalent wrapper for the `/apply/:token`
 * candidate flow. Rendered outside the auth gate: no sidebar, no user menu.
 */
const PublicLeaveShell = ({ children, companyName }: PublicLeaveShellProps) => {
...
export default PublicLeaveShell;
